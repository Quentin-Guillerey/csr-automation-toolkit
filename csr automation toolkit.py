...
STANDARD_RESPONSES = [
    ...
    (["warranty", "claim", "refund"], "ewsh",
     ...
     "All warranty discussions should be directed to the authorized service center of your choosing.",
     True),
    (["thank you", "thanks"], "caa",
     "You're welcome. It's my pleasure to help you. Is there anything else I can assist you with? "
     "Would you like me to send you an email as a reference for our discussion?", False),
]
